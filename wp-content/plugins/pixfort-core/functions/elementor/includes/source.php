...
class Source_Custom extends Source_Base {
	...
	public static function get_template_content( $template_id ) {
		...
		if($file){
			$template_content = json_decode( pix_file_get_contents( PIX_CORE_PLUGIN_DIR.'/functions/elementor/includes/demo/files/'.$file ) , true );
		}
		// $template_content = [];
		// // if ( file_exists( dirname( __FILE__ ) . 'demo/'.$template_id.'.json' ) ) {
