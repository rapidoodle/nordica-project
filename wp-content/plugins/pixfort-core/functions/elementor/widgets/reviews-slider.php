...
class Pix_Eor_Reviews_Slider extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-reviews-slider-handle', PIX_CORE_PLUGIN_URI.'functions/elementor/js/reviews-slider.js', [ 'elementor-frontend' ], PIXFORT_PLUGIN_VERSION, true );
   	}
