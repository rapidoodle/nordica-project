        ...
        $output .= '<div class="card mb-3 mb-sm-0 pix-info-card '.$el_classes.'" '.$anim_type.' '.$anim_delay.'>';
             $output .= '<div class="card-inner">';
                    $output .= '<a href="'.$link.'" '.$linkTarget.'>';
                        if($position=='top'){
                            $output .= '<img class="card-img animating fade-in-Img" src="'.$imgSrc.'" alt="Card image">';
                        ...
                        $output .= '</div>';
                        if($position!='top'){
                            $output .= '<img class="card-img-bottom animating fade-in-Img" src="'.$imgSrc.'" alt="Card image">';
                        }
                   $output .= '</a>';
               $output .= '</div>';
         $output .= '</div>';
