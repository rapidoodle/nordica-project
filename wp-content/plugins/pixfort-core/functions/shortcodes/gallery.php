...
if( ! function_exists( 'sc_pix_gallery' ) ){
	function sc_pix_gallery( $attr, $content = null ){
        ...
        // $output .= '<a class="pix-lightbox" data-fancybox="gallery" data-caption="My caption" href="http://localhost/prod/wp-content/uploads/2020/10/cta-image.png"><img src="http://localhost/prod/wp-content/uploads/2020/10/cta-image.png"></a>';
        // $output .= '<a data-fancybox="gallery" data-caption="My caption 2" href="http://localhost/prod/wp-content/uploads/2020/10/cta-image.png"><img src="http://localhost/prod/wp-content/uploads/2020/10/cta-image.png"></a>';
                    ...
                    foreach ($items_arr as $key => $value) {
                        ...
                        if(!empty($image)){
                            ...
                            if(!empty($enable_link)){
                                $output .='<a class="card pix-hover-item '.$cardClasses.'" href="'.$link.'" '.$target_out.'>';
