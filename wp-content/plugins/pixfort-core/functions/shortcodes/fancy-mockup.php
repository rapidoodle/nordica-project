	...
	function sc_pix_fancy_mockup( $attr, $content = null ){
        ...
        if(!empty($image)){
			...
			$output = '<div class="pix-fancy-mockup">
                ...
                <div class="pix-fancy-content">';
					if(empty($imgSrcset)){
						$output .= '<img class="" src="'.$imgSrc.'" alt="logo image">';	
					}else{
						$output .= '<img class="" src="'.$imgSrc.'" srcset="'.$imgSrcset.'" sizes="'.$imgSizes.'" alt="logo image">';
					}

                $output .= '</div>
                    <img class="pix-fancy-device-img" src="'.PIX_CORE_PLUGIN_URI.'functions/images/ipad.png" alt="logo image">
                  </div>';
