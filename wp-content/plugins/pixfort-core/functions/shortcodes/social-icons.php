			...
			foreach ($icons as $key => $value) {
	            ...
	            if(!empty($value['icon'])) {
		            ...
		            if(!empty($value['item_link'])) {
		                $output .= '<a '.$linkTarget.' href="'.$value['item_link'].'" class="'.$w_color.' '.$anim_class.' d-inline-block '.$items_style.' '.$i_size.' '.$icon_padding.'" '.$anim_type.' '.$icon_delay.'><i class="'.$value["icon"].'" '.$w_custom_style.'></i></a>';
		            }else{
