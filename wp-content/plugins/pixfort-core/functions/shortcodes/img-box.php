...
if( ! function_exists( 'sc_pix_img_box' ) ){
	...
	function sc_pix_img_box( $attr, $content = null ){
		...
		$output .= '<div class="item-inner '.$class_names.' '.$css_class.' w-100 h-1002 bg-'.$overlay_color.' shadow2 pix-hover-item mb-32  '.$rounded_img.' position-relative overflow-hidden" '.$el_style.' '.$anim_type.' '.$anim_delay.'>
