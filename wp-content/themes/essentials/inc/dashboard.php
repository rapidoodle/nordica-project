                ...
                <div>
                    ...
                    $status = $pixfortHub->checkValidation();
                        ...
                        <div class="pix-dashboard-alert">
                            <strong>Important Note:</strong> if you want to activate this license on a different domain you should deactivate it from here first <a href="https://essentials.pixfort.com/knowledge-base/deactivate-your-license/" target="_blank">Check this article</a>
                        </div>
