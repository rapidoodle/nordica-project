...
function pixfort_demo_forms(){
    ...
    $demo = array(
        ...
        'import_file_url'            => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/demos/contact-forms/horizontal-subscription-form.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Contact Form 7' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/demos/contact-forms/contact-form.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Contact Form 7' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/demos/contact-forms/advanced-contact-form.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Contact Form 7' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/demos/contact-forms/vertical-subscription-form.xml',
