...
function pixfort_demo_misc(){
    ...
    $demo = array(
        ...
        'import_file_url'            => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/demos/default-menu.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Miscellaneous' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/portfolio-12-items.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Miscellaneous' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/portfolio-items-elementor.xml',
    ...
    // if(defined('PIX_DEMO')){
        $demo = array(
            ...
            'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/demo-menu.xml',
